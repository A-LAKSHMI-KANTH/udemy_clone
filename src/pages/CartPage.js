        ...
        <div className='cart-grid grid'>
          ...
          <div className='cart-grid-right'>
            <div className='cart-total'>
              ...
              <div className='cart-total-value fw-8'>Rs{total_amount.toFixed(2)}</div>
              <button type = "button" className='checkout-btn bg-purple text-white fw-6' onClick={() => setIsModalVisible(true)}>Checkout</button>
              <ReactplosiveModal
      title={<h4>Congratulations!</h4>}
      isVisible={isModalVisible}
      onClose={() => setIsModalVisible(false)}
    >
      <p> Thanks for purchasing the courses, kindly check your mail</p>
